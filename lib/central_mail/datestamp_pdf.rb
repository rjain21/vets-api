...
module CentralMail
  class DatestampPdf
    ...
    def run(settings)
      ...
      generate_stamp(stamp_path, settings[:text], settings[:x], settings[:y], settings[:text_only], settings[:size], settings[:timestamp], settings[:page_number], settings[:template])
