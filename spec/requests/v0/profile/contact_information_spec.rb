...
# lots of this file cribbed from spec/requests/va_profile/telephone_request_spec.rb
RSpec.describe 'contact_information' do
  ...
  #         post('/v0/profile/contact_informations', params: telephone.to_json, headers:)
  ...
  #       VCR.use_cassette('va_profile/contact_information/post_telephone_success') do
  #         post('/v0/profile/contact_informations', params: telephone.to_json, headers: headers_with_camel)
  ...
  # describe 'PUT /v0/profile/contact_informations' do
  #   let(:contact_information) { build(:contact_information, vet360_id: user.vet360_id) }
  ...
  #         put('/v0/profile/contact_informations', params: telephone.to_json, headers:)
  ...
  #     it 'matches the telephone camel-inflected schema', :aggregate_failures do
  #       VCR.use_cassette('va_profile/contact_information/put_telephone_success') do
  #         put('/v0/profile/contact_informations', params: telephone.to_json, headers: headers_with_camel)
  ...
  # describe 'DELETE /v0/profile/contact_informations' do
  ...
  #         delete('/v0/profile/contact_informations', params: telephone.to_json, headers:)
  #         expect(response).to have_http_status(:ok)
  #         expect(response).to match_response_schema('va_profile/transaction_response')
  #       end
  #     end
  ...
  #         # The cassette we're using includes the effectiveEndDate in the body.
  #         # So this test will not pass if it's missing
  #         delete('/v0/profile/contact_informations', params: telephone.to_json, headers: headers_with_camel)
  #         expect(response).to have_http_status(:ok)
  #         expect(response).to match_camelized_response_schema('va_profile/transaction_response')
  #       end
  #     end
